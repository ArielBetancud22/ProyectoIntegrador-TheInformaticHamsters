...
public class Animaciones extends Utilidades {
        ...
        // Tipo: 0 - Cliente no Abonado. 1 - Cliente no registrado
        public static int tipoCliente, numeroTicket, dni;
        public static String nombreCompleto;
        private static final int VALOR_TICKET = 150;
        private static final int VALOR_ABONO = 3000;

        public static int getVALOR_TICKET() {
                return VALOR_TICKET;
        }

        public static int getVALOR_ABONO() {
                return VALOR_ABONO;
        }
        ...
        public static void continuarConOtroCliente() {
                ...
                do {
                        if (opcionElegida == 1) {
                                ...
                                System.out.println(" ");
                                System.out.print(
                                                "		                                                Ingrese una opción válida deseada: ");
                                opcionElegida = lectura.nextInt();
                        }
